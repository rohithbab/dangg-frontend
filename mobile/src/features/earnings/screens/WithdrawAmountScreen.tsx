...
const styles = StyleSheet.create({
  ...
  currency: { fontFamily: InterFont.light, fontSize: scaleFont(40), color: AppColors.onSurfaceMuted },
  amountInput: {
    flex: 1,
  ...
  maxText: { fontFamily: InterFont.medium, fontSize: scaleFont(14), color: AppColors.primary },
  hint: {
    fontFamily: InterFont.regular,
  ...
  destBody: { flex: 1, marginLeft: moderateScale(14) },
  destName: { fontFamily: InterFont.medium, fontSize: scaleFont(15), color: AppColors.onSurface },
  destSub: {
    fontFamily: InterFont.regular,
  ...
  destChange: { fontFamily: InterFont.medium, fontSize: scaleFont(14), color: AppColors.primary },
  ctaWrap: {
