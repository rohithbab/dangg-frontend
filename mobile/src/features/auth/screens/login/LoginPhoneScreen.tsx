...
/**
 * OTP login — phone entry (Neue). Sends a login OTP to an existing account and
 * hands off to the shared OTP screen. There is no password anywhere in the app.
 */
function LoginPhoneScreen(): React.ReactElement {
  ...
  const handleContinue = useCallback(async (): Promise<void> => {
    ...
    try {
      ...
      if (e instanceof AppException) {
        ...
        logger.error('LoginPhoneScreen.sendOtp failed', e);
